                        ...
                        <div class="col-12 col-sm-10">
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                echo "<tr>
                                        <td>" . $row['id']."</td>
                                        <td>" . $row['sku']."</td>
                                        <td align='center'><a class='download-btn' href='outputs/womens/dungarees/regular-cropped-long/jpg/" . $row['sku']."_M.jpg' download='" . $row['sku']."'>Download</a></td></tr>";
                                }

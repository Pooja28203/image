            ...
            <div class="col-12 col-sm-10">
                ...
                <section id="category" class="section container-fluid category">
                    ...
                    <div class="row no-gutters justify-content-center content scroll-content">
                        <div class="col-12 col-sm-10">
                            <?php
                            $sql = "SELECT * FROM womens_sh_dungarees";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                echo "<tr>
                                        <td>" . $row['id']."</td>
                                        <td>" . $row['sku']."</td>
                                        <td align='center'><a class='download-btn' href='outputs/womens/dungarees/shorts/jpg/" . $row['sku']."_M.jpg' download='" . $row['sku']."'>Download</a></td></tr>";
                                }

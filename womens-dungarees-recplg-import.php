			...
			<div class="col-12 col-sm-10">
				...
				<section id="login" class="section container-fluid login">
					<div class="row no-gutters justify-content-center headline">
						<div class="col-12">
							<h3>Women's Dungarees Import</h3>
							<h6>(Regular, Long and Cropped)</h6>
						</div>
					</div>
						...
						<div class="col-12">
							<div class="row no-gutters justify-content-center">
								...
								<div class="col-12 col-sm-8 elements">
									<form class="csvUpload" id="csvUpload" enctype="multipart/form-data" method="post" action="womens-dungarees-recplg-upload.php">
